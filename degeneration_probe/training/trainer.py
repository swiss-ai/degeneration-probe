...
from degeneration_probe.utils.file_utils import save_jsonl
from degeneration_probe.utils.metrics import print_eval_metrics
    ...
    def evaluate(
        ...
        for dataset in self.eval_datasets:
            ...
            metrics = evaluate_probe(
                ...
                save_dir=self.probe_dir if (save_roc_curves or dump_raw_eval_results) else None,
